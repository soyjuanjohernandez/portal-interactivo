...
* El dispositivo Bluetooth puede desconectarse en cualquier momento. Se recomienda escuchar el evento de devolución de llamada [my.onBLEConnectionStateChanged](/). Cuando el dispositivo BLE se desconecte, realice la operación de reconexión según sea necesario.
