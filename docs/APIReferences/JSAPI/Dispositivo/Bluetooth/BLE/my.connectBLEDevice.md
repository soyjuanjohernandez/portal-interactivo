...
Use esta API para conectarse a un dispositivo Bluetooth de baja energía (BLE).

Instrucciones:

* Si el programa MINI ha descubierto previamente un dispositivo Bluetooth y se ha conectado con éxito, puede pasar directamente la ID del dispositivo obtenida previamente para conectarse al dispositivo, sin la necesidad de realizar una operación de búsqueda.
* Si el dispositivo Bluetooth especificado ya está conectado, la solicitud de conexión repetida devolverá el éxito directamente.
