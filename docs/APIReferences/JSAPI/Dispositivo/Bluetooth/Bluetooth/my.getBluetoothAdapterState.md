...
Utilice esta API para comprobar el estado del adaptador Bluetooth en el Mini Programa.
...
<table>
    <tr>
     ...
     <tr>
        <td>discovering</td>
        <td>Booleano</td>
        <td>Indica si se está descubriendo el dispositivo Bluetooth.</td>
     </tr>
     <tr>
        <td>available</td>
        <td>Booleano</td>
        <td>Indica si Bluetooth está disponible (BLE debe ser compatible y encendido).</td>
     </tr>
</table>
