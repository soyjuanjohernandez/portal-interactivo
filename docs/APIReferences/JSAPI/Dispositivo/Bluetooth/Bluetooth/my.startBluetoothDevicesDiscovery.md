...
Utiliza esta API para empezar a descubrir dispositivos bluetooth. Puedes encontrar los resultados en la API [my.onBluetoothDeviceFound](./my.onBluetoothDeviceFound).

:::info[NOTA:]
Para evitar consumir demasiados recursos del sistema, detenga la búsqueda llamando a la API **my.stopBluetoothDevicesDiscovery** después de encontrar y conectarse al dispositivo.
...
<table>
    ...
    <tr>
        ...
        <td>Array</td>
        <td>No</td>
        <td>Lista de UUID del servicio en el dispositivo Bluetooth.</td>
     </tr>
     <tr>
        <td>allowDuplicatesKey</td>
        <td>Boolean</td>
        <td>No</td>
        <td>Determina si permitir claves duplicadas.En caso afirmativo, la API [my.onbluetoothdevicefound](./my.onbluetoothdevicefound) informará para este dispositivo, con diferentes valores RSSI.</td>
     </tr>
     <tr>
        <td>interval</td>
        <td>Integer</td>
        <td>No</td>
        <td>Por defecto, el intervalo es 0, lo que significa que una vez que se encuentra un nuevo dispositivo, se informará el dispositivo;De lo contrario, la frecuencia de informes es el valor de intervalo.</td>
     </tr>
     <tr>
        <td>success</td>
        <td>Función</td>
