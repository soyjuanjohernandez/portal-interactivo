...
Utilice esta API para obtener los dispositivos bluetooth que están conectados.

**Instrucciones:**

* Si has buscado antes un dispositivo bluetooth en el miniprograma, puedes pasar directamente el deviceId obtenido por la búsqueda anterior para conectarte al dispositivo.
* Si el dispositivo bluetooth especificado está conectado, se le devolverá una respuesta de éxito si se repite la conexión.
...
<table>
    ...
    <tr>
        ...
        <td>String</td>
        <td>Si</td>
        <td>ID de dispositivo del Bluetooth.</td>
     </tr>
     <tr>
        <td>success</td>
        <td>Función</td>
