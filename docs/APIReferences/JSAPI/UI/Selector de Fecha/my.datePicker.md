...
<table>
    <tr>
     ...
     <tr>
        ...
        <td>String</td>
        <td>No</td>
        <td>La fecha y la hora inicialmente seleccionadas.Por defecto, se utilizan la fecha y hora de hora actuales.</td>
     </tr>
     <tr>
        <td>startDate</td>
        <td>String</td>
...
* aaaa-mm-dd (predeterminado)
* HH: mm
* aaaa-mm-dd HH: mm
* aaaa-mm.Pase en ```canIUse('datePicker.object.format.yyyy-MM')``` a [my.canIUse](/portal-interactivo/docs/APIReferences/JSAPI/Básica/my.canIUse) para consultar si se puede usar la versión actual.
* aaaa.Pase en ```canIUse('datePicker.object.format.yyyy')``` a [my.canIUse](/portal-interactivo/docs/APIReferences/JSAPI/Básica/my.canIUse) para consultar si se puede usar la versión actual.
